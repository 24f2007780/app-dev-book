...
![](https://pplx-res.cloudinary.com/image/upload/v1745586612/gpt4o_images/ntd9bjpsd4j7llv0txdu.png)
...
> [!attention] Foreign key column goes on the "many" side in one-to-many (or many-to-one)
