...
0. **[Setting Up Development Environment](appdev-I-theory/week0/week0-index.md)**<br>
    ...
    - basic modules for your python programs
...
- Gained a strong understanding of web application development using Flask (backend) and basic HTML/CSS (frontend).
...
- Understand basics of computer networking, client–server communication, github, testing and user interface heuristics
- Perform CRUD operations via different HTTP methods.
