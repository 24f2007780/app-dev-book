        ...
        '/appdev-I-theory/': [
          {
            ...
            items: [
              {
                text: 'Week0: Basic Guide',
                link: '/appdev-I-theory/week0/week0-index',
                collapsed: true,
                items: [
                  {
              ...
              {
                text: 'Week1: Intro to Applications',
                link: '/appdev-I-theory/week1/week1-index',
                collapsed: true,
                items: [
                  {
              ...
              },
              {
                ...
                items: [
                  {
                    text: 'Database: MODEL',
                    link: '/appdev-I-theory/week4/4-database-layer-MODEL',
                  },
                  {
                    text: 'SQL Recap',
        ...
        '/appdev-II-theory/': [
          {
            ...
            items: [
              { text: 'Week 1 - 4' },
              {
                ...
                items: [
                  ...
                  { text: 'Math Operators', link: `${JS_PREFIX}/operators` },
                  {
                    ...
                    link: `${JS_PREFIX}/comparisonoperators`,
                  },
                  {
                    text: 'Logical Operators',
                    link: `${JS_PREFIX}/logicaloperators`,
                  },
                  {
                    text: 'Type Conversion',
                    link: `${JS_PREFIX}/typeconversion`,
                  },
                  ...
                  {
                    text: 'Call Bind Apply',
                    link: `${JS_PREFIX}/callbindapply`,
                  },
              ...
              },
              {
                text: 'Vue JS',
                collapsed: false,
                items: [{ text: 'Introduction', link: `${VUE_PREFIX}/vue` }],
              },
              { text: 'Week 5 - 8' },
              {
                ...
                items: [
                  ...
                  {
                    text: 'Async Await',
                    link: '/appdev-II-theory/placeholder',
                  },
        ...
        '/appdev-II-project/': [
          {
            ...
            items: [
              { text: "FAQ's", link: '/appdev-II-project/faq' },
              {
                ...
                link: '/appdev-II-project/project-statement',
              },
              {
                text: 'Development Environment',
                link: '/appdev-II-project/development-environment-setup',
              },
              { text: 'Flask', link: '/appdev-II-project/code-examples' },
              {
                text: 'SQL Alchemy Models',
                link: '/appdev-II-project/sqlalchemy-models',
              },
              {
                text: 'Flask Security',
                link: '/appdev-II-project/flask-security',
              },
              // { text: 'CLI', link: '/reference/cli' },
              // { text: 'API', link: '/reference/api' }
            ],
