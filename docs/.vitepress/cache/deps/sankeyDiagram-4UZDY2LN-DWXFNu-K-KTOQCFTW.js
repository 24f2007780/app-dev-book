...
// node_modules/vitepress-mermaid-preview/dist/sankeyDiagram-4UZDY2LN-DWXFNu-K.js
function Nt(t) {
...
function Bt() {
  let t = 0, e = 0, i = 1, a = 1, h2 = 24, b = 8, p, k = Dt, s = mt, o, l, _ = $t, x = jt, y = 6;
  function v() {
...
ot.prototype = kt.prototype = {
  ...
  arcTo: function(t, e, i, a, h2) {
    ...
    if (this._x1 === null)
      ...
      var x = i - b, y = a - p, v = k * k + s * s, M = x * x + y * y, T = Math.sqrt(v), N = Math.sqrt(_), C = h2 * Math.tan((st - Math.acos((v + _ - M) / (2 * T * N))) / 2), D = C / N, R = C / T;
      Math.abs(D - 1) > F && (this._ += "L" + (t + D * o) + "," + (e + D * l)), this._ += "A" + h2 + "," + h2 + ",0,0," + +(l * x > o * y) + "," + (this._x1 = t + R * k) + "," + (this._y1 = e + R * s);
    }
  },
  arc: function(t, e, i, a, h2, b) {
    t = +t, e = +e, i = +i, b = !!b;
    var p = i * Math.cos(a), k = i * Math.sin(a), s = t + p, o = e + k, l = 1 ^ b, _ = b ? a - h2 : h2 - a;
    if (i < 0) throw new Error("negative radius: " + i);
    this._x1 === null ? this._ += "M" + s + "," + o : (Math.abs(this._x1 - s) > F || Math.abs(this._y1 - o) > F) && (this._ += "L" + s + "," + o), i && (_ < 0 && (_ = _ % rt + rt), _ > Rt ? this._ += "A" + i + "," + i + ",0,1," + l + "," + (t - p) + "," + (e - k) + "A" + i + "," + i + ",0,1," + l + "," + (this._x1 = s) + "," + (this._y1 = o) : _ > F && (this._ += "A" + i + "," + i + ",0," + +(_ >= st) + "," + l + "," + (this._x1 = t + i * Math.cos(h2)) + "," + (this._y1 = e + i * Math.sin(h2))));
  },
...
function Yt(t) {
  ...
  return p.source = function(k) {
    ...
    return arguments.length ? (a = typeof k == "function" ? k : dt2(+k), p) : a;
  }, p.y = function(k) {
    return arguments.length ? (h2 = typeof k == "function" ? k : dt2(+k), p) : h2;
...
var at = function() {
  var t = g(function(k, s, o, l) {
    ...
    performAction: g(function(s, o, l, _, x, y, v) {
      var M = y.length - 1;
      switch (x) {
        case 7:
...
` + this.showPosition(), {
      ...
      performAction: g(function(o, l, _, x) {
        switch (_) {
          case 0:
  ...
  return g(p, "Parser"), p.prototype = h2, h2.Parser = p, new p();
}();
at.parser = at;
var K = at;
var J = [];
...
var oe = {
  nodesMap: Z,
  getConfig: g(() => gt().sankey, "getConfig"),
  getNodes: ie,
  getLinks: se,
  getGraph: re,
  addLink: te,
...
var le = g(function(t, e, i, a) {
  const { securityLevel: h2, sankey: b } = gt(), p = VF.sankey;
  let k;
  h2 === "sandbox" && (k = dt("#i" + e));
  const s = h2 === "sandbox" ? dt(k.nodes()[0].contentDocument.body) : dt("body"), o = h2 === "sandbox" ? s.select(`[id="${e}"]`) : dt(`[id="${e}"]`), l = (b == null ? void 0 : b.width) ?? p.width, _ = (b == null ? void 0 : b.height) ?? p.width, x = (b == null ? void 0 : b.useMaxWidth) ?? p.useMaxWidth, y = (b == null ? void 0 : b.nodeAlignment) ?? p.nodeAlignment, v = (b == null ? void 0 : b.prefix) ?? p.prefix, M = (b == null ? void 0 : b.suffix) ?? p.suffix, T = (b == null ? void 0 : b.showValues) ?? p.showValues, N = a.db.getGraph(), C = ae[y];
  Bt().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (T ? 15 : 0)).nodeAlign(C).extent([
    [0, 0],
    [l, _]
  ])(N);
  const S = h(It);
  o.append("g").attr("class", "nodes").selectAll(".node").data(N.nodes).join("g").attr("class", "node").attr("id", (d) => (d.uid = gt2.next("node-")).id).attr("transform", function(d) {
...
${v}${Math.round(E * 100) / 100}${M}` : d, "getText");
  ...
  const B = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(N.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), O = (b == null ? void 0 : b.linkColor) ?? "gradient";
  if (O === "gradient") {
    const d = B.append("linearGradient").attr("id", (E) => (E.uid = gt2.next("linearGradient-")).id).attr("gradientUnits", "userSpaceOnUse").attr("x1", (E) => E.source.x1).attr("x2", (E) => E.target.x0);
  ...
  B.append("path").attr("d", Kt()).attr("stroke", z).attr("stroke-width", (d) => Math.max(1, d.width)), Ab(void 0, o, 0, x);
}, "draw");
var ce = {
  draw: le
};
var ue = g((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing");
var he = g((t) => `.label {
      font-family: ${t.fontFamily};
    }`, "getStyles");
var fe = he;
var ye = K.parse.bind(K);
K.parse = (t) => ye(ue(t));
var pe = {
  styles: fe,
  parser: K,
...
//# sourceMappingURL=sankeyDiagram-4UZDY2LN-DWXFNu-K-KTOQCFTW.js.map
