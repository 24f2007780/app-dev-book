...
// node_modules/vitepress-mermaid-preview/dist/graph-Mvt8qLAi.js
var w = iS(function(o) {
  return Pt(Ot(o, 1, Xk, true));
});
var F = "\0";
var a = "\0";
var O = "";
var L = class {
  ...
  setDefaultNodeLabel(e) {
    return ac(e) || (e = K_(e)), this._defaultNodeLabelFn = e, this;
  }
  nodeCount() {
  ...
  sources() {
    var e = this;
    return _t(this.nodes(), function(t) {
      return Iu(e._in[t]);
    });
  }
  sinks() {
  ...
  removeNode(e) {
    if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
      ...
      delete this._nodes[e], this._isCompound && (this._removeFromParentsChildList(e), delete this._parent[e], $t(this.children(e), (s) => {
        this.setParent(s);
      }), delete this._children[e]), $t($(this._in[e]), t), delete this._in[e], delete this._preds[e], $t($(this._out[e]), t), delete this._out[e], delete this._sucs[e], --this._nodeCount;
    }
    return this;
  }
  setParent(e, t) {
    ...
    if (Et(t))
      ...
      t += "";
      for (var s = t; !Et(s); s = this.parent(s))
        if (s === e)
  ...
  filterNodes(e) {
    ...
    var s = this;
    $t(this._nodes, function(n, h) {
      e(h) && t.setNode(h, n);
    }), $t(this._edgeObjs, function(n) {
    ...
    return this._isCompound && $t(t.nodes(), function(n) {
      t.setParent(n, r(n));
    }), t;
  }
  /* === Edge functions ========== */
  setDefaultEdgeLabel(e) {
    return ac(e) || (e = K_(e)), this._defaultEdgeLabelFn = e, this;
  }
  edgeCount() {
    return this._edgeCount;
  }
  edges() {
    return St(this._edgeObjs);
  }
  setPath(e, t) {
    var s = this, i = arguments;
    return It(e, function(r, n) {
  ...
  setEdge() {
    ...
    typeof n == "object" && n !== null && "v" in n ? (e = n.v, t = n.w, s = n.name, arguments.length === 2 && (i = arguments[1], r = true)) : (e = n, t = arguments[1], s = arguments[3], arguments.length > 2 && (i = arguments[2], r = true)), e = "" + e, t = "" + t, Et(s) || (s = "" + s);
...
//# sourceMappingURL=chunk-MA5DQ6BL.js.map
