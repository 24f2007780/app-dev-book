...
// node_modules/vitepress-mermaid-preview/dist/mindmap-definition-6CBA2TL7-BFDwf-B3.js
var tt = { exports: {} };
var et2 = { exports: {} };
var rt = { exports: {} };
var Ct = rt.exports;
      ...
      return (
        ...
        function(u) {
          ...
          function y(r) {
            ...
            return u[r].call(t.exports, t, t.exports, y), t.l = true, t.exports;
          }
          ...
          function(u, D, y) {
            ...
            function i(g2, a, v) {
              r.call(this, v), this.isOverlapingSourceAndTarget = false, this.vGraphObject = v, this.bendpoints = [], this.source = g2, this.target = a;
            }
            ...
            i.prototype.getSource = function() {
            ...
            }, i.prototype.getOtherEnd = function(g2) {
              if (this.source === g2)
                return this.target;
              if (this.target === g2)
                return this.source;
              throw "Node is not incident with this edge";
            }, i.prototype.getOtherEndInGraph = function(g2, a) {
              for (var v = this.getOtherEnd(g2), n = a.getGraphManager().getRoot(); ; ) {
                if (v.getOwner() == a)
                  return v;
                if (v.getOwner() == n)
                  break;
              ...
              var g2 = new Array(4);
              this.isOverlapingSourceAndTarget = t.getIntersection(this.target.getRect(), this.source.getRect(), g2), this.isOverlapingSourceAndTarget || (this.lengthX = g2[0] - g2[2], this.lengthY = g2[1] - g2[3], Math.abs(this.lengthX) < 1 && (this.lengthX = e.sign(this.lengthX)), Math.abs(this.lengthY) < 1 && (this.lengthY = e.sign(this.lengthY)), this.length = Math.sqrt(this.lengthX * this.lengthX + this.lengthY * this.lengthY));
          ...
          /***/
          function(u, D, y) {
            var r = y(2), t = y(10), e = y(13), i = y(0), o = y(16), g2 = y(4);
            function a(n, c, l, E) {
            ...
            a.prototype.getEdges = function() {
              ...
              return new g2(this.rect.x + this.rect.width / 2, this.rect.y + this.rect.height / 2);
            }, a.prototype.getLocation = function() {
              return new g2(this.rect.x, this.rect.y);
              ...
              var E = new g2(c, l), T = n.inverseTransformPoint(E);
          ...
          /***/
          function(u, D, y) {
            var r = y(2), t = y(10), e = y(0), i = y(6), o = y(3), g2 = y(1), a = y(13), v = y(12), n = y(11);
            function c(E, T, m) {
            ...
            c.prototype.getNodes = function() {
              ...
              if (E instanceof o) {
                ...
                var N2 = this.nodes.indexOf(T);
                if (N2 == -1)
                  throw "Node not in owner node list!";
                this.nodes.splice(N2, 1);
                ...
                var N2 = L.source.owner.getEdges().indexOf(L);
                if (N2 == -1)
                  throw "Not in owner's edge list!";
                L.source.owner.getEdges().splice(N2, 1);
              }
            }, c.prototype.updateLeftTop = function() {
              for (var E = t.MAX_VALUE, T = t.MAX_VALUE, m, L, O, d = this.getNodes(), N2 = d.length, s = 0; s < N2; s++) {
                var h = d[s];
              ...
              for (var T = t.MAX_VALUE, m = -t.MAX_VALUE, L = t.MAX_VALUE, O = -t.MAX_VALUE, d, N2, s, h, f, p = this.nodes, A = p.length, I = 0; I < A; I++) {
                var R = p[I];
                E && R.child != null && R.updateBounds(), d = R.getLeft(), N2 = R.getRight(), s = R.getTop(), h = R.getBottom(), T > d && (T = d), m < N2 && (m = N2), L > s && (L = s), O < h && (O = h);
              }
              ...
              for (var T = t.MAX_VALUE, m = -t.MAX_VALUE, L = t.MAX_VALUE, O = -t.MAX_VALUE, d, N2, s, h, f = E.length, p = 0; p < f; p++) {
                var A = E[p];
                d = A.getLeft(), N2 = A.getRight(), s = A.getTop(), h = A.getBottom(), T > d && (T = d), m < N2 && (m = N2), L > s && (L = s), O < h && (O = h);
              }
              ...
              var T = new n(), m = /* @__PURE__ */ new Set(), L = this.nodes[0], O, d, N2 = L.withChildren();
              for (N2.forEach(function(I) {
                T.push(I), m.add(I);
              }); T.length !== 0; ) {
          ...
          function(u, D, y) {
            ...
            e.prototype.addRoot = function() {
              var i = this.layout.newGraph(), o = this.layout.newNode(null), g2 = this.add(i, o);
              return this.setRootGraph(g2), this.rootGraph;
            }, e.prototype.add = function(i, o, g2, a, v) {
              if (g2 == null && a == null && v == null) {
                if (i == null)
                  throw "Graph is null!";
                if (o == null)
                ...
                if (n == c)
                  return g2.isInterGraph = false, n.add(g2, a, v);
                if (g2.isInterGraph = true, g2.source = a, g2.target = v, this.edges.indexOf(g2) > -1)
                  throw "Edge already in inter-graph edge list!";
                if (this.edges.push(g2), !(g2.source != null && g2.target != null))
                  throw "Edge source and/or target is null!";
                if (!(g2.source.edges.indexOf(g2) == -1 && g2.target.edges.indexOf(g2) == -1))
                  throw "Edge already in source and/or target incidency list!";
                return g2.source.edges.push(g2), g2.target.edges.push(g2), g2;
              }
              ...
              if (i instanceof r) {
                ...
                var g2 = [];
                g2 = g2.concat(o.getEdges());
                for (var a, v = g2.length, n = 0; n < v; n++)
                  a = g2[n], o.remove(a);
                var c = [];
              ...
              if (this.allNodes == null) {
                for (var i = [], o = this.getGraphs(), g2 = o.length, a = 0; a < g2; a++)
              ...
              if (this.allEdges == null) {
                ...
                o.length;
                for (var g2 = 0; g2 < o.length; g2++)
                  i = i.concat(o[g2].getEdges());
              ...
              var g2 = i.getOwner(), a;
              do {
                if (a = g2.getParent(), a == null)
                  break;
                if (a == o)
                  return true;
                if (g2 = a.getOwner(), g2 == null)
                  break;
              } while (true);
              g2 = o.getOwner();
              do {
              ...
              for (var i, o, g2, a, v, n = this.getAllEdges(), c = n.length, l = 0; l < c; l++) {
                if (i = n[l], o = i.source, g2 = i.target, i.lca = null, i.sourceInLca = o, i.targetInLca = g2, o == g2) {
                  i.lca = o.getOwner();
                  continue;
                }
                for (a = o.getOwner(); i.lca == null; ) {
                  for (i.targetInLca = g2, v = g2.getOwner(); i.lca == null; ) {
                    if (v == a) {
                      i.lca = v;
                      break;
                    }
              ...
              do {
                ...
                g2 = g2.getParent().getOwner();
              } while (true);
              return g2;
            }, e.prototype.calcInclusionTreeDepths = function(i, o) {
              i == null && o == null && (i = this.rootGraph, o = 1);
              for (var g2, a = i.getNodes(), v = a.length, n = 0; n < v; n++)
                g2 = a[n], g2.inclusionTreeDepth = o, g2.child != null && this.calcInclusionTreeDepths(g2.child, o + 1);
            }, e.prototype.includesInvalidEdge = function() {
              for (var i, o = this.edges.length, g2 = 0; g2 < o; g2++)
                if (i = this.edges[g2], this.isOneAncestorOfOther(i.source, i.target))
                  return true;
              return false;
            }, u.exports = e;
          },
          ...
          function(u, D, y) {
            ...
            t.calcSeparationAmount = function(e, i, o, g2) {
              if (!e.intersects(i))
                throw "assert failed";
              var a = new Array(2);
              ...
              var n = v * o[0], c = o[1] / v;
              o[0] < c ? c = o[0] : n = o[1], o[0] = -1 * a[0] * (c / 2 + g2), o[1] = -1 * a[1] * (n / 2 + g2);
              ...
              var g2 = e.getCenterX(), a = e.getCenterY(), v = i.getCenterX(), n = i.getCenterY();
              if (e.intersects(i))
                return o[0] = g2, o[1] = a, o[2] = v, o[3] = n, true;
              var c = e.getX(), l = e.getY(), E = e.getRight(), T = e.getX(), m = e.getBottom(), L = e.getRight(), O = e.getWidthHalf(), d = e.getHeightHalf(), N2 = i.getX(), s = i.getY(), h = i.getRight(), f = i.getX(), p = i.getBottom(), A = i.getRight(), I = i.getWidthHalf(), R = i.getHeightHalf(), x = false, G = false;
              if (g2 === v) {
                if (a > n)
                  return o[0] = g2, o[1] = l, o[2] = v, o[3] = p, false;
                if (a < n)
                  return o[0] = g2, o[1] = m, o[2] = v, o[3] = s, false;
              } else if (a === n) {
                if (g2 > v)
                  return o[0] = c, o[1] = a, o[2] = h, o[3] = n, false;
                if (g2 < v)
                  return o[0] = E, o[1] = a, o[2] = N2, o[3] = n, false;
              } else {
                var U = e.height / e.width, X = i.height / i.width, w = (n - a) / (v - g2), S = void 0, F = void 0, b = void 0, Y = void 0, k = void 0, H2 = void 0;
                if (-U === w ? g2 > v ? (o[0] = T, o[1] = m, x = true) : (o[0] = E, o[1] = l, x = true) : U === w && (g2 > v ? (o[0] = c, o[1] = l, x = true) : (o[0] = L, o[1] = m, x = true)), -X === w ? v > g2 ? (o[2] = f, o[3] = p, G = true) : (o[2] = h, o[3] = s, G = true) : X === w && (v > g2 ? (o[2] = N2, o[3] = s, G = true) : (o[2] = A, o[3] = p, G = true)), x && G)
                  return false;
                if (g2 > v ? a > n ? (S = this.getCardinalDirection(U, w, 4), F = this.getCardinalDirection(X, w, 2)) : (S = this.getCardinalDirection(-U, w, 3), F = this.getCardinalDirection(-X, w, 1)) : a > n ? (S = this.getCardinalDirection(-U, w, 1), F = this.getCardinalDirection(-X, w, 3)) : (S = this.getCardinalDirection(U, w, 2), F = this.getCardinalDirection(X, w, 4)), !x)
                  switch (S) {
                    case 1:
                      Y = l, b = g2 + -d / w, o[0] = b, o[1] = Y;
                      break;
                    case 2:
                      b = L, Y = a + O * w, o[0] = b, o[1] = Y;
                      break;
                    case 3:
                      Y = m, b = g2 + d / w, o[0] = b, o[1] = Y;
                      break;
                    case 4:
                ...
                if (!G)
                  switch (F) {
                    case 1:
                      H2 = s, k = v + -R / w, o[2] = k, o[3] = H2;
                      break;
                    case 2:
                      k = A, H2 = n + I * w, o[2] = k, o[3] = H2;
                      break;
                    case 3:
                      H2 = p, k = v + R / w, o[2] = k, o[3] = H2;
                      break;
                    case 4:
                      k = f, H2 = n + -I * w, o[2] = k, o[3] = H2;
                      break;
                  }
              }
              return false;
              ...
              return e > i ? o : 1 + o % 4;
            }, t.getIntersection = function(e, i, o, g2) {
              if (g2 == null)
                return this.getIntersection2(e, i, o);
              var a = e.x, v = e.y, n = i.x, c = i.y, l = o.x, E = o.y, T = g2.x, m = g2.y, L = void 0, O = void 0, d = void 0, N2 = void 0, s = void 0, h = void 0, f = void 0, p = void 0, A = void 0;
              return d = c - v, s = a - n, f = n * v - a * c, N2 = m - E, h = l - T, p = T * E - l * m, A = d * h - N2 * s, A === 0 ? null : (L = (s * p - h * f) / A, O = (N2 * f - d * p) / A, new r(L, O));
            }, t.angleOfVector = function(e, i, o, g2) {
              var a = void 0;
              return e !== o ? (a = Math.atan((g2 - i) / (o - e)), o < e ? a += Math.PI : g2 < i && (a += this.TWO_PI)) : g2 < i ? a = this.ONE_AND_HALF_PI : a = this.HALF_PI, a;
            }, t.doIntersect = function(e, i, o, g2) {
              var a = e.x, v = e.y, n = i.x, c = i.y, l = o.x, E = o.y, T = g2.x, m = g2.y, L = (n - a) * (m - E) - (T - l) * (c - v);
              if (L === 0)
                return false;
          ...
          function(u, D, y) {
            var r = /* @__PURE__ */ function() {
              function a(v, n) {
                for (var c = 0; c < n.length; c++) {
                  var l = n[c];
                  l.enumerable = l.enumerable || false, l.configurable = true, "value" in l && (l.writable = true), Object.defineProperty(v, l.key, l);
                }
              }
            ...
            var e = function(v) {
              ...
              function a(v) {
                var n = this;
                t(this, a), this.length = 0, this.head = null, this.tail = null, v == null ? void 0 : v.forEach(function(c) {
                  return n.push(c);
                });
              }
              return r(a, [{
          ...
          function(u, D, y) {
            ...
            var t = y(0), e = y(6), i = y(3), o = y(1), g2 = y(5), a = y(4), v = y(17), n = y(27);
            function c(l) {
            ...
            c.RANDOM_SEED = 1, c.prototype = Object.create(n.prototype), c.prototype.getGraphManager = function() {
              ...
              return new g2(null, this.graphManager, l);
              ...
              } else if (l instanceof g2) {
                var N2 = l;
                if (N2.vGraphObject != null) {
                  var s = N2.vGraphObject;
                  s.update(N2);
                }
              }
              ...
              if (!m)
                return l;
              var O = /* @__PURE__ */ new Set(), d = [], N2 = /* @__PURE__ */ new Map(), s = [];
              for (s = s.concat(T); s.length > 0 && E; ) {
                ...
                if (!E)
                  ...
                  O = /* @__PURE__ */ new Set(), N2 = /* @__PURE__ */ new Map();
                }
              }
              return l;
              ...
              for (var E = 0; E < l.length; E++) {
                ...
                if (T.bendpoints.length > 0) {
                  for (var m = this.edgeToDummyNodes.get(T), L = 0; L < m.length; L++) {
                    var O = m[L], d = new a(O.getCenterX(), O.getCenterY()), N2 = T.bendpoints.get(L);
                    N2.x = d.x, N2.y = d.y, O.getOwner().remove(O);
                  }
              ...
              if (T != null && m != null) {
                ...
                var N2, s;
                return l <= 50 ? (N2 = 9 * E / 500, s = E / 10) : (N2 = 9 * E / 50, s = -8 * E), N2 * l + s;
              }
              ...
              for (var d = 0; d < E.length; d++) {
                var N2 = E[d], s = N2.getNeighborsList().size;
                m.set(N2, N2.getNeighborsList().size), s == 1 && T.push(N2);
              }
              var h = [];
              for (h = h.concat(T); !L; ) {
                var f = [];
                f = f.concat(h), h = [];
                for (var d = 0; d < E.length; d++) {
                  var N2 = E[d], p = E.indexOf(N2);
                  p >= 0 && E.splice(p, 1);
                  var A = N2.getNeighborsList();
          ...
          function(u, D, y) {
            ...
            var t = y(15), e = y(7), i = y(0), o = y(8), g2 = y(9);
            function a() {
            ...
            a.prototype.initParameters = function() {
              ...
              var l = n.getRect(), E = c.getRect(), T = new Array(2), m = new Array(4), L, O, d, N2, s, h, f;
              if (l.intersects(E)) {
                ...
                this.uniformLeafNodeSizes && n.getChild() == null && c.getChild() == null ? (L = E.getCenterX() - l.getCenterX(), O = E.getCenterY() - l.getCenterY()) : (o.getIntersection(l, E, m), L = m[2] - m[0], O = m[3] - m[1]), Math.abs(L) < e.MIN_REPULSION_DIST && (L = g2.sign(L) * e.MIN_REPULSION_DIST), Math.abs(O) < e.MIN_REPULSION_DIST && (O = g2.sign(O) * e.MIN_REPULSION_DIST), d = L * L + O * O, N2 = Math.sqrt(d), s = this.repulsionConstant * n.noOfChildren * c.noOfChildren / d, h = s * L / N2, f = s * O / N2, n.repulsionForceX -= h, n.repulsionForceY -= f, c.repulsionForceX += h, c.repulsionForceY += f;
                ...
                for (var m, L = this.grid, O = n.startX - 1; O < n.finishX + 2; O++)
                  for (var d = n.startY - 1; d < n.finishY + 2; d++)
                    if (!(O < 0 || d < 0 || O >= L.length || d >= L[0].length)) {
                      for (var N2 = 0; N2 < L[O][d].length; N2++)
                        if (m = L[O][d][N2], !(n.getOwner() != m.getOwner() || n == m) && !c.has(m) && !T.has(m)) {
          ...
          function(u, D, y) {
            var r = y(1), t = y(7);
            function e(o, g2, a) {
              r.call(this, o, g2, a), this.idealLength = t.DEFAULT_EDGE_LENGTH;
            }
          ...
          function(u, D, y) {
            var r = y(3);
            function t(i, o, g2, a) {
              r.call(this, i, o, g2, a), this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            t.prototype = Object.create(r.prototype);
            for (var e in r)
              t[e] = r[e];
            t.prototype.setGridCoordinates = function(i, o, g2, a) {
              this.startX = i, this.finishX = o, this.startY = g2, this.finishY = a;
            }, u.exports = t;
          },
          /* 21 */
          /***/
          ...
          function(u, D, y) {
            ...
            t.prototype.add = function(e) {
              ...
              for (var i = Object.keys(this.set), o = i.length, g2 = 0; g2 < o; g2++)
                e.push(this.set[i[g2]]);
            }, t.prototype.size = function() {
              return Object.keys(this.set).length;
          ...
          function(u, D, y) {
            var r = /* @__PURE__ */ function() {
              function o(g2, a) {
                for (var v = 0; v < a.length; v++) {
                  var n = a[v];
                  n.enumerable = n.enumerable || false, n.configurable = true, "value" in n && (n.writable = true), Object.defineProperty(g2, n.key, n);
                }
              }
              return function(g2, a, v) {
                return a && o(g2.prototype, a), v && o(g2, v), g2;
              };
            }();
            function t(o, g2) {
              if (!(o instanceof g2))
            ...
            var e = y(11), i = function() {
              function o(g2, a) {
                ...
                var v = void 0;
                g2 instanceof e ? v = g2.size() : v = g2.length, this._quicksort(g2, 0, v - 1);
              }
              return r(o, [{
                key: "_quicksort",
          ...
          function(u, D, y) {
            var r = /* @__PURE__ */ function() {
              function i(o, g2) {
                for (var a = 0; a < g2.length; a++) {
                  var v = g2[a];
                  v.enumerable = v.enumerable || false, v.configurable = true, "value" in v && (v.writable = true), Object.defineProperty(o, v.key, v);
                }
              }
              return function(o, g2, a) {
                return g2 && i(o.prototype, g2), a && i(o, a), o;
              };
            }();
            function t(i, o) {
              if (!(i instanceof o))
            ...
            var e = function() {
              function i(o, g2) {
                ...
                t(this, i), this.sequence1 = o, this.sequence2 = g2, this.match_score = a, this.mismatch_penalty = v, this.gap_penalty = n, this.iMax = o.length + 1, this.jMax = g2.length + 1, this.grid = new Array(this.iMax);
              ...
              return r(i, [{
                ...
                key: "computeGrids",
                value: function() {
                  for (var g2 = 1; g2 < this.jMax; g2++)
                    this.grid[0][g2] = this.grid[0][g2 - 1] + this.gap_penalty, this.tracebackGrid[0][g2] = [false, false, true];
                ...
                value: function() {
                  ...
                  for (g2.push({
                    ...
                    var a = g2[0], v = this.tracebackGrid[a.pos[0]][a.pos[1]];
                    v[0] && g2.push({
                ...
                key: "getAllIndexes",
                value: function(g2, a) {
                  for (var v = [], n = -1; (n = g2.indexOf(a, n + 1)) !== -1; )
                    v.push(n);
                  return v;
                }
              }, {
                ...
                value: function(g2) {
                  return this.getAllIndexes(g2, Math.max.apply(null, g2));
                }
              }]), i;
            }();
            u.exports = e;
          ...
          function(u, D, y) {
            ...
            t.addListener = function(e, i) {
              ...
              for (var o = this.listeners.length; o >= 0; o--) {
                var g2 = this.listeners[o];
                g2.event === e && g2.callback === i && this.listeners.splice(o, 1);
              }
            }, t.emit = function(e, i) {
              for (var o = 0; o < this.listeners.length; o++) {
                var g2 = this.listeners[o];
                e === g2.event && g2.callback(i);
              }
            }, u.exports = r;
          }
          /******/
      ...
      return (
        ...
        function(D) {
          ...
          function(D, y, r) {
            ...
            function i(g2, a, v, n) {
              t.call(this, g2, a, v, n);
            }
            i.prototype = Object.create(t.prototype);
            for (var o in t)
              i[o] = t[o];
            i.prototype.move = function() {
              var g2 = this.graphManager.getLayout();
              this.displacementX = g2.coolingFactor * (this.springForceX + this.repulsionForceX + this.gravitationForceX) / this.noOfChildren, this.displacementY = g2.coolingFactor * (this.springForceY + this.repulsionForceY + this.gravitationForceY) / this.noOfChildren, Math.abs(this.displacementX) > g2.coolingFactor * g2.maxNodeDisplacement && (this.displacementX = g2.coolingFactor * g2.maxNodeDisplacement * e.sign(this.displacementX)), Math.abs(this.displacementY) > g2.coolingFactor * g2.maxNodeDisplacement && (this.displacementY = g2.coolingFactor * g2.maxNodeDisplacement * e.sign(this.displacementY)), this.child == null ? this.moveBy(this.displacementX, this.displacementY) : this.child.getNodes().length == 0 ? this.moveBy(this.displacementX, this.displacementY) : this.propogateDisplacementToChildren(this.displacementX, this.displacementY), g2.totalDisplacement += Math.abs(this.displacementX) + Math.abs(this.displacementY), this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0;
            }, i.prototype.propogateDisplacementToChildren = function(g2, a) {
              for (var v = this.getChild().getNodes(), n, c = 0; c < v.length; c++)
                n = v[c], n.getChild() == null ? (n.moveBy(g2, a), n.displacementX += g2, n.displacementY += a) : n.propogateDisplacementToChildren(g2, a);
            }, i.prototype.setPred1 = function(g2) {
              this.pred1 = g2;
            }, i.prototype.getPred1 = function() {
              return pred1;
            }, i.prototype.getPred2 = function() {
              return pred2;
            }, i.prototype.setNext = function(g2) {
              this.next = g2;
            }, i.prototype.getNext = function() {
              return next;
            }, i.prototype.setProcessed = function(g2) {
              this.processed = g2;
          ...
          /***/
          function(D, y, r) {
            var t = r(0).FDLayout, e = r(4), i = r(3), o = r(5), g2 = r(2), a = r(1), v = r(0).FDLayoutConstants, n = r(0).LayoutConstants, c = r(0).Point, l = r(0).PointD, E = r(0).Layout, T = r(0).Integer, m = r(0).IGeometry, L = r(0).LGraph, O = r(0).Transform;
            function d() {
            ...
            d.prototype.newGraphManager = function() {
              ...
              return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(f, p), this.calcGravitationalForces(), this.moveNodes(), this.animate(), false;
              ...
              for (var s = [], h = true, f; h; ) {
                var p = this.graphManager.getAllNodes(), A = [];
                h = false;
                for (var I = 0; I < p.length; I++)
                  f = p[I], f.getEdges().length == 1 && !f.getEdges()[0].isInterGraph && f.getChild() == null && (A.push([f, f.getEdges()[0], f.getOwner()]), h = true);
                if (h == true) {
              ...
              for (var b = T.MAX_VALUE, Y, k, H2 = 0; H2 < S.length; H2++)
                S[H2] < b ? (b = S[H2], Y = 1, k = H2) : S[H2] == b && Y++;
              if (Y == 3 && b == 0)
    ...
    (function(D, y) {
      ...
      return (
        ...
        function(D) {
          ...
          /***/
          function(D, y, r) {
            var t = r(0).layoutBase.LayoutConstants, e = r(0).layoutBase.FDLayoutConstants, i = r(0).CoSEConstants, o = r(0).CoSELayout, g2 = r(0).CoSENode, a = r(0).layoutBase.PointD, v = r(0).layoutBase.DimensionD, n = {
            ...
            l.prototype.run = function() {
              ...
              this.idToLNode = {};
              var d = this.layout = new o(), N2 = this;
              N2.stopped = false, this.cy = this.options.cy, this.cy.trigger({ type: "layoutstart", layout: this });
              ...
              var G = function(w, S) {
                typeof w == "number" && (w = S);
                var F = w.data("id"), b = N2.idToLNode[F];
                return {
                ...
                for (var w = function() {
                  O.fit && O.cy.fit(O.eles, O.padding), m || (m = true, N2.cy.one("layoutready", O.ready), N2.cy.trigger({ type: "layoutready", layout: N2 }));
                }, S = N2.options.refresh, F, b = 0; b < S && !F; b++)
                  F = N2.stopped || N2.layout.tick();
                if (F) {
                  d.checkLayoutSuccess() && !d.isSubLayout && d.doPostLayout(), d.tilingPostLayout && d.tilingPostLayout(), d.isLayoutFinished = true, N2.options.eles.nodes().positions(G), w(), N2.cy.one("layoutstop", N2.options.stop), N2.cy.trigger({ type: "layoutstop", layout: N2 }), L && cancelAnimationFrame(L), m = false;
                  return;
                }
                var Y = N2.layout.getPositionsData();
                O.eles.nodes().positions(function(k, H2) {
                  if (typeof k == "number" && (k = H2), !k.isParent()) {
              ...
              return d.addListener("layoutstarted", function() {
                N2.options.animate === "during" && (L = requestAnimationFrame(U));
              }), d.runLayout(), this.options.animate !== "during" && (N2.options.eles.nodes().not(":parent").layoutPositions(N2, N2.options, G), m = false), this;
            }, l.prototype.getTopMostNodes = function(m) {
              for (var L = {}, O = 0; O < m.length; O++)
                L[m[O].id()] = true;
              var d = m.filter(function(N2, s) {
                typeof N2 == "number" && (N2 = s);
                for (var h = N2.parent()[0]; h != null; ) {
                  if (L[h.id()])
                    return false;
                  h = h.parent()[0];
                }
              ...
              for (var d = L.length, N2 = 0; N2 < d; N2++) {
                var s = L[N2], h = s.children(), f, p = s.layoutDimensions({
                  nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
                });
                if (s.outerWidth() != null && s.outerHeight() != null ? f = m.add(new g2(O.graphManager, new a(s.position("x") - p.w / 2, s.position("y") - p.h / 2), new v(parseFloat(p.w), parseFloat(p.h)))) : f = m.add(new g2(this.graphManager)), f.id = s.data("id"), f.paddingLeft = parseInt(s.css("padding")), f.paddingTop = parseInt(s.css("padding")), f.paddingRight = parseInt(s.css("padding")), f.paddingBottom = parseInt(s.css("padding")), this.options.nodeDimensionsIncludeLabels && s.isParent()) {
                  var A = s.boundingBox({ includeLabels: true, includeNodes: false }).w, I = s.boundingBox({ includeLabels: true, includeNodes: false }).h, R = s.css("text-halign");
...
var _t = yx(Gt);
var at = function() {
  var C = g(function(O, d, N2, s) {
    for (N2 = N2 || {}, s = O.length; s--; N2[O[s]] = d) ;
    return N2;
  }, "o"), M = [1, 4], u = [1, 13], D = [1, 12], y = [1, 15], r = [1, 16], t = [1, 20], e = [1, 19], i = [6, 7, 8], o = [1, 26], g2 = [1, 24], a = [1, 25], v = [6, 7, 11], n = [1, 6, 13, 15, 16, 19, 22], c = [1, 33], l = [1, 34], E = [1, 6, 7, 11, 13, 15, 16, 19, 22], T = {
    trace: g(function() {
    }, "trace"),
    yy: {},
    ...
    performAction: g(function(d, N2, s, h, f, p, A) {
      var I = p.length - 1;
      switch (f) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: M }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: M }, { 6: u, 7: [1, 10], 9: 9, 12: 11, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e }, C(i, [2, 3]), { 1: [2, 2] }, C(i, [2, 4]), C(i, [2, 5]), { 1: [2, 6], 6: u, 12: 21, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e }, { 6: u, 9: 22, 12: 11, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e }, { 6: o, 7: g2, 10: 23, 11: a }, C(v, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: t, 22: e }), C(v, [2, 18]), C(v, [2, 19]), C(v, [2, 20]), C(v, [2, 21]), C(v, [2, 23]), C(v, [2, 24]), C(v, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: o, 7: g2, 10: 32, 11: a }, { 1: [2, 7], 6: u, 12: 21, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e }, C(n, [2, 14], { 7: c, 11: l }), C(E, [2, 8]), C(E, [2, 9]), C(E, [2, 10]), C(v, [2, 15]), C(v, [2, 16]), C(v, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, C(n, [2, 13], { 7: c, 11: l }), C(E, [2, 11]), C(E, [2, 12]), { 21: [1, 37] }, C(v, [2, 25]), C(v, [2, 27])],
    defaultActions: { 2: [2, 1], 6: [2, 2] },
    parseError: g(function(d, N2) {
      if (N2.recoverable)
        this.trace(d);
      else {
        var s = new Error(d);
    ...
    parse: g(function(d) {
      var N2 = this, s = [0], h = [], f = [null], p = [], A = this.table, I = "", R = 0, x = 0, G = 2, U = 1, X = p.slice.call(arguments, 1), w = Object.create(this.lexer), S = { yy: {} };
      ...
      function H2() {
        var B;
        return B = h.pop() || w.lex() || U, typeof B != "number" && (B instanceof Array && (h = B, B = h.pop()), B = N2.symbols_[B] || B), B;
      }
      g(H2, "lex");
      for (var P, W, $, j, V = {}, z, Z, lt, q; ; ) {
        if (W = s[s.length - 1], this.defaultActions[W] ? $ = this.defaultActions[W] : ((P === null || typeof P > "u") && (P = H2()), $ = A[W] && A[W][P]), typeof $ > "u" || !$.length || !$[0]) {
          var nt = "";
          q = [];
          for (z in A[W])
...
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : nt = "Parse error on line " + (R + 1) + ": Unexpected " + (P == U ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(nt, {
    ...
    var O = {
      EOF: 1,
      parseError: g(function(N2, s) {
        if (this.yy.parser)
          this.yy.parser.parseError(N2, s);
        else
          throw new Error(N2);
      }, "parseError"),
      // resets the lexer, sets new input
      setInput: g(function(d, N2) {
        return this.yy = N2 || this.yy || {}, this._input = d, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
      ...
      input: g(function() {
        ...
        var N2 = d.match(/(?:\r\n?|\n).*/g);
        return N2 ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), d;
      }, "input"),
      // unshifts one char (or a string) into the input
      unput: g(function(d) {
        var N2 = d.length, s = d.split(/(?:\r\n?|\n)/g);
        this._input = d + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - N2), this.offset -= N2;
        ...
        return this.yylloc = {
          ...
          last_column: s ? (s.length === h.length ? this.yylloc.first_column : 0) + h[h.length - s.length].length - s[0].length : this.yylloc.first_column - N2
        }, this.options.ranges && (this.yylloc.range = [f[0], f[0] + this.yyleng - N2]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + this.showPosition(), {
      ...
      showPosition: g(function() {
        var d = this.pastInput(), N2 = new Array(d.length + 1).join("-");
        return d + this.upcomingInput() + `
` + N2 + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: g(function(d, N2) {
        var s, h, f;
      ...
      next: g(function() {
        ...
        for (var f = this._currentRules(), p = 0; p < f.length; p++)
          if (s = this._input.match(this.rules[f[p]]), s && (!N2 || s[0].length > N2[0].length)) {
            if (N2 = s, h = p, this.options.backtrack_lexer) {
              if (d = this.test_match(s, f[p]), d !== false)
                return d;
              if (this._backtrack) {
                N2 = false;
                continue;
        ...
        return N2 ? (d = this.test_match(N2, f[h]), d !== false ? d : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: g(function(N2, s, h, f) {
        switch (h) {
          case 0:
          ...
          case 34:
            return this.popState(), N2.getLogger().trace("node end (("), "NODE_DEND";
          case 35:
            return N2.getLogger().trace("Long description:", s.yytext), 20;
          case 36:
            return N2.getLogger().trace("Long description:", s.yytext), 20;
        }
      }, "anonymous"),
...
var Ut = (K = class {
  ...
  addNode(M, u, D, y) {
    var _a, _b;
    N.info("addNode", M, u, D, y);
    const r = gt();
    let t = ((_a = r.mindmap) == null ? void 0 : _a.padding) ?? Cf.mindmap.padding;
    switch (y) {
    ...
    const e = {
      ...
      type: y,
      children: [],
      width: ((_b = r.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? Cf.mindmap.maxNodeWidth,
      padding: t
    }, i = this.getParent(M);
    if (i)
  ...
  getType(M, u) {
    switch (N.debug("In get type", M, u), M) {
      case "[":
  ...
  decorateNode(M) {
    if (!M)
      return;
    const u = gt(), D = this.nodes[this.nodes.length - 1];
    M.icon && (D.icon = Er(M.icon, u)), M.class && (D.class = Er(M.class, u));
  }
  type2Str(M) {
    switch (M) {
...
`);
  await dr(
    ...
    y
  ), r || g2.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle");
  const v = g2.node().getBBox(), [n] = Ea(y.fontSize);
  if (u.height = v.height + n * 1.1 * 0.5 + u.padding, u.width = v.width + 2 * u.padding, u.icon)
    if (u.type === C.nodeType.CIRCLE)
      u.height += 50, u.width += 50, e.append("foreignObject").attr("height", "50px").attr("width", u.width).attr("style", "text-align: center;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + t + " " + u.icon), g2.attr(
        "transform",
      ...
      e.append("foreignObject").attr("width", "60px").attr("height", u.height).attr("style", "text-align: center;margin-top:" + l / 2 + "px;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + t + " " + u.icon), g2.attr(
        "transform",
    ...
    g2.attr("transform", "translate(" + c + ", " + l + ")");
  } else {
...
function dt2(C, M) {
  M.edges().map((u, D) => {
    ...
    if (u[0]._private.bodyBounds) {
      ...
      N.trace("Edge: ", D, y), C.insert("path").attr(
        "d",
...
function vt(C, M) {
  return new Promise((u) => {
    const D = dt("body").append("div").attr("id", "cy").attr("style", "display:none"), y = ea({
...
function yt(C, M) {
  M.nodes().map((u, D) => {
    ...
    N.info("id:", D, "Position: (", u.position().x, ", ", u.position().y, ")", y), r.attr(
      "transform",
...
` + C);
  ...
  const t = gt();
  t.htmlLabels = false;
  const e = XB(M), i = e.append("g");
  i.attr("class", "mindmap-edges");
  const o = e.append("g");
  o.attr("class", "mindmap-nodes"), await ot(y, o, r, -1, t);
  const g2 = await vt(r, t);
  dt2(i, g2), yt(y, g2), Ab(
    void 0,
    e,
    ((_a = t.mindmap) == null ? void 0 : _a.padding) ?? Cf.mindmap.padding,
    ((_b = t.mindmap) == null ? void 0 : _b.useMaxWidth) ?? Cf.mindmap.useMaxWidth
  );
}, "draw");
var jt = {
  draw: Qt
...
var zt = g((C) => {
  ...
  for (let u = 0; u < C.THEME_COLOR_LIMIT; u++)
    C["lineColor" + u] = C["lineColor" + u] || C["cScaleInv" + u], Ln(C["lineColor" + u]) ? C["lineColor" + u] = H(C["lineColor" + u], 20) : C["lineColor" + u] = et(C["lineColor" + u], 20);
  for (let u = 0; u < C.THEME_COLOR_LIMIT; u++) {
    const D = "" + (17 - 3 * u);
    M += `
...
//# sourceMappingURL=mindmap-definition-6CBA2TL7-BFDwf-B3-4THWXW42.js.map
