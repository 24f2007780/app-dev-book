...
// node_modules/vitepress-mermaid-preview/dist/layout-WNGYi_OX.js
function He(e) {
  return rS(X_(e, void 0, fn), e + "");
}
var Je = 1;
var Ze = 4;
function Ke(e) {
...
function S(e, n) {
  var r = {};
  return n = Ln(n), lt(e, function(t, a, i) {
    oc(r, a, n(t, a, i));
  }), r;
}
function y(e) {
  return e && e.length ? tn(e, _g, nn) : void 0;
}
function U(e, n) {
  return e && e.length ? tn(e, Ln(n), rn) : void 0;
}
function rn2(e, n) {
  var r = e.length;
  for (e.sort(n); r--; )
...
function tn2(e, n) {
  if (e !== n) {
    var r = e !== void 0, t = e === null, a = e === e, i = B(e), o = n !== void 0, u = n === null, d = n === n, s = B(n);
...
function on2(e, n, r) {
  ...
  var a = V(e, function(i, o, u) {
    var d = bn(n, function(s) {
      return s(i);
    });
    return { criteria: d, index: ++t, value: i };
  });
  return rn2(a, function(i, o) {
    return an(i, o, r);
  });
}
function un2(e, n) {
  return vn(e, n, function(r, t) {
    return it(e, t);
  });
}
var I = He(function(e, n) {
  return e == null ? {} : un2(e, n);
});
var dn2 = Math.ceil;
var sn = Math.max;
function fn2(e, n, r, t) {
  for (var a = -1, i = sn(dn2((n - e) / (r || 1)), 0), o = Array(i); i--; )
    o[++a] = e, e += r;
  return o;
}
function cn(e) {
  return function(n, r, t) {
    return t && typeof t != "number" && nS(n, r, t) && (r = t = void 0), n = K(n), r === void 0 ? (r = n, n = 0) : r = K(r), t = t === void 0 ? n < r ? 1 : -1 : K(t), fn2(n, r, t);
  };
}
var E = cn();
var R = iS(function(e, n) {
  if (e == null)
    return [];
  var r = n.length;
  return r > 1 && nS(e, n[0], n[1]) ? n = [] : r > 2 && nS(n[0], n[1], n[2]) && (n = [n[0]]), on2(e, Ot(n), []);
});
var ln = 0;
function H(e) {
  var n = ++ln;
...
function mn2(e, n) {
  if (e.nodeCount() <= 1)
    return [];
  var r = yn2(e, n || bn2), t = gn2(r.graph, r.buckets, r.zeroIdx);
  return fn(
    gn(t, function(a) {
...
function kn(e) {
  var n = e.graph().acyclicer === "greedy" ? mn2(e, r(e)) : xn(e);
  $t(n, function(t) {
    var a = e.edge(t);
...
function te(e, n, r, t) {
  ...
  return arguments.length >= 4 && (a.rank = r, a.order = t), L2(e, "border", a, n);
}
function me(e) {
  return y(
    gn(e.nodes(), function(n) {
      var r = e.node(n).rank;
      if (!Et(r))
        return r;
    })
...
function ae(e, n, r, t, a, i) {
  var o = { width: 0, height: 0, rank: i, borderType: n }, u = a[n][i - 1], d = L2(e, "border", o, r);
...
function In(e) {
  $t(e.nodes(), function(n) {
    ...
    var r = e.edge(n);
    $t(r.points, B2), Object.prototype.hasOwnProperty.call(r, "y") && B2(r);
  });
}
function B2(e) {
  e.y = -e.y;
  ...
  if (i !== t + 1) {
    ...
    for (l = 0, ++t; t < i; ++l, ++t)
      u.points = [], s = {
        ...
        edgeObj: n,
        rank: t
      }, c = L2(e, "edge", s, "_d"), t === d && (s.width = u.width, s.height = u.height, s.dummy = "edge-label", s.labelpos = u.labelpos), e.setEdge(r, c, { weight: u.weight }, o), l === 0 && e.graph().dummyChains.push(c), r = c;
...
function ye(e) {
  var n = new L({ directed: false }), r = e.nodes()[0], t = e.nodeCount();
  n.setNode(r, {});
  for (var a, i; Vn(n, e) < t; )
    a = An(n, e), i = n.hasNode(a.v) ? C2(e, a) : -C2(e, a), Bn(n, e, i);
  return n;
}
function Vn(e, n) {
  function r(t) {
    $t(n.nodeEdges(t), function(a) {
      ...
      !e.hasNode(o) && !C2(n, a) && (e.setNode(o, {}), e.setEdge(t, o, {}), r(o));
    });
  }
...
function Pe(e, n, r, t) {
  var a = r.v, i = r.w;
  e.removeEdge(a, i), e.setEdge(t.v, t.w, {}), K2(e), Z(e, n), Wn(e, n);
}
function Wn(e, n) {
  var r = hn(e.nodes(), function(a) {
...
function Hn(e) {
  var n = L2(e, "root", {}, "_root"), r = Jn(e), t = y(St(r)) - 1, a = 2 * t + 1;
...
function er(e, n, r) {
  var t = nr(e), a = new L({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(i) {
    return e.node(i);
  });
...
function _e(e, n, r, t) {
  ...
  cr(c, d);
  var l = sr(c, t);
  if (o && (l.vs = fn([o, l.vs, u]), e.predecessors(o).length)) {
...
function hr(e) {
  var n = me(e), r = se(e, E(1, n + 1), "inEdges"), t = se(e, E(n - 1, -1, -1), "outEdges"), a = ar2(e);
  fe(e, a);
...
function yr(e, n) {
  if (e.node(n).dummy)
    return hn(e.predecessors(n), function(r) {
...
function Or(e, n, r, t) {
  var a = new L(), i = e.graph(), o = _r(i.nodesep, i.edgesep, t);
  return $t(n, function(u) {
    var d;
    $t(u, function(s) {
      var c = r[s];
...
function Nr(e, n) {
  var r = St(n), t = on(r), a = y(r);
  $t(["u", "d"], function(i) {
    $t(["l", "r"], function(o) {
      var u = i + o, d = e[u], s;
      if (d !== n) {
        var c = St(d);
        s = o === "l" ? t - on(c) : a - y(c), s && (e[u] = S(d, function(l) {
          return l + s;
        }));
      }
    });
...
function Cr(e) {
  var n = F(e), r = aS(mr(e, n), gr(e, n)), t = {}, a;
  $t(["u", "d"], function(o) {
    a = o === "u" ? n : St(n).reverse(), $t(["l", "r"], function(u) {
      u === "r" && (a = gn(a, function(l) {
        return St(l).reverse();
      }));
...
var Fr = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"];
var jr = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" };
var Vr = ["acyclicer", "ranker", "rankdir", "align"];
var Ar = ["width", "height"];
var Br = { width: 0, height: 0 };
var Gr = ["minlen", "weight", "width", "height", "labeloffset"];
var Yr = {
  minlen: 1,
  weight: 1,
  width: 0,
...
var Dr = ["labelpos"];
function qr(e) {
  var n = new L({ multigraph: true, compound: true }), r = D(e.graph());
  return n.setGraph(
    aS({}, jr, Y(r, Fr), I(r, Vr))
  ), $t(e.nodes(), function(t) {
    var a = D(e.node(t));
    n.setNode(t, dn(Y(a, Ar), Br)), n.setParent(t, e.parent(t));
...
function Kr(e) {
  $t(e.nodes(), function(n) {
    if (e.children(n).length) {
      var r = e.node(n), t = e.node(r.borderTop), a = e.node(r.borderBottom), i = e.node(un(r.borderLeft)), o = e.node(un(r.borderRight));
...
//# sourceMappingURL=chunk-VPWCPGR5.js.map
