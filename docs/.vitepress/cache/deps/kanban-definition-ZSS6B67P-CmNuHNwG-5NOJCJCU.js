...
// node_modules/vitepress-mermaid-preview/dist/kanban-definition-ZSS6B67P-CmNuHNwG.js
var $ = function() {
  var e = g(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), u = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], E = [1, 16], b = [1, 20], l2 = [1, 19], D = [6, 7, 8], I = [1, 26], g2 = [1, 24], w = [1, 25], _ = [6, 7, 11], G = [1, 31], N2 = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], m = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], H2 = [1, 38], T = {
    trace: g(function() {
    }, "trace"),
    yy: {},
    ...
    performAction: g(function(i, n, r, a, h, t, M) {
      var c = t.length - 1;
      switch (h) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: u }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: u }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l2 }, e(D, [2, 3]), { 1: [2, 2] }, e(D, [2, 4]), e(D, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l2 }, { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l2 }, { 6: I, 7: g2, 10: 23, 11: w }, e(_, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: b, 23: l2 }), e(_, [2, 19]), e(_, [2, 21], { 15: 30, 24: G }), e(_, [2, 22]), e(_, [2, 23]), e(N2, [2, 25]), e(N2, [2, 26]), e(N2, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: I, 7: g2, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: E, 18: 17, 19: 18, 20: b, 23: l2 }, e(V, [2, 14], { 7: m, 11: A }), e(L, [2, 8]), e(L, [2, 9]), e(L, [2, 10]), e(_, [2, 16], { 15: 37, 24: G }), e(_, [2, 17]), e(_, [2, 18]), e(_, [2, 20], { 24: H2 }), e(N2, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(V, [2, 13], { 7: m, 11: A }), e(L, [2, 11]), e(L, [2, 12]), e(_, [2, 15], { 24: H2 }), e(N2, [2, 30]), { 22: [1, 41] }, e(N2, [2, 27]), e(N2, [2, 29])],
...
` + this.showPosition(), {
      ...
      performAction: g(function(n, r, a, h) {
        switch (a) {
          case 0:
  ...
  return g(B, "Parser"), B.prototype = T, T.Parser = B, new B();
}();
$.parser = $;
var xe = $;
var v = [];
...
var Le = g(function() {
  ...
  for (const d of p) {
    ...
    for (const l2 of b) {
      const D = {
        ...
        label: Er(l2.label ?? "", s),
        isGroup: false,
        ticket: l2 == null ? void 0 : l2.ticket,
        priority: l2 == null ? void 0 : l2.priority,
        assigned: l2 == null ? void 0 : l2.assigned,
        icon: l2 == null ? void 0 : l2.icon,
        shape: "kanbanItem",
        level: l2.level,
        rx: 5,
        ry: 5,
  ...
  return { nodes: u, edges: e, other: {}, config: gt() };
}, "getData");
var Oe = g((e, u, p, s, d) => {
  var _a, _b;
  const E = gt();
  let b = ((_a = E.mindmap) == null ? void 0 : _a.padding) ?? Cf.mindmap.padding;
  switch (s) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  const l2 = {
    ...
    level: e,
    label: Er(p, E),
    width: ((_b = E.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? Cf.mindmap.maxNodeWidth,
    padding: b,
    isGroup: false
  };
  if (d !== void 0) {
...
` + d + `
    ...
    const g2 = K1(I, { schema: X1 });
    if (g2.shape && (g2.shape !== g2.shape.toLowerCase() || g2.shape.includes("_")))
      throw new Error(`No such shape: ${g2.shape}. Shape names should be lowercase.`);
    (g2 == null ? void 0 : g2.shape) && g2.shape === "kanbanItem" && (l2.shape = g2 == null ? void 0 : g2.shape), (g2 == null ? void 0 : g2.label) && (l2.label = g2 == null ? void 0 : g2.label), (g2 == null ? void 0 : g2.icon) && (l2.icon = g2 == null ? void 0 : g2.icon.toString()), (g2 == null ? void 0 : g2.assigned) && (l2.assigned = g2 == null ? void 0 : g2.assigned.toString()), (g2 == null ? void 0 : g2.ticket) && (l2.ticket = g2 == null ? void 0 : g2.ticket.toString()), (g2 == null ? void 0 : g2.priority) && (l2.priority = g2 == null ? void 0 : g2.priority);
  }
  const D = De(e);
...
var Ie = g((e, u) => {
  switch (N.debug("In get type", e, u), e) {
    case "[":
      return f.RECT;
    case "(":
...
var we = g((e) => {
  if (!e)
    return;
  const u = gt(), p = v[v.length - 1];
  e.icon && (p.icon = Er(e.icon, u)), e.class && (p.cssClasses = Er(e.class, u));
}, "decorateNode");
var Ae = g((e) => {
  switch (e) {
    case f.DEFAULT:
...
var Te = g(() => N, "getLogger");
var Re = g((e) => ie[e], "getElementById");
var Pe = {
  clear: ve,
  addNode: Oe,
  getSections: he,
...
var Ve = Pe;
var Be = g(async (e, u, p, s) => {
  var _a, _b, _c, _d, _e;
  N.debug(`Rendering kanban diagram
` + e);
  const E = s.db.getData(), b = gt();
  b.htmlLabels = false;
  const l2 = XB(u), D = l2.append("g");
  D.attr("class", "sections");
  const I = l2.append("g");
  I.attr("class", "items");
  const g2 = E.nodes.filter(
  ...
  for (const m of g2) {
    ...
    const L = await eB(D, m);
    N2 = Math.max(N2, (_b = L == null ? void 0 : L.labelBBox) == null ? void 0 : _b.height), G.push(L);
  }
  let V = 0;
  for (const m of g2) {
    const A = G[V];
    V = V + 1;
    const L = ((_c = b == null ? void 0 : b.kanban) == null ? void 0 : _c.sectionWidth) || 200, H2 = -L * 3 / 2 + N2;
    let T = H2;
    ...
    for (const i of K) {
      ...
      const r = (await Ly(I, i, { config: b })).node().getBBox();
      i.y = T + r.height / 2, await g3(i), T = i.y + r.height / 2 + _ / 2;
    }
    const B = A.cluster.select("rect"), O = Math.max(T - H2 + 3 * _, 50) + (N2 - 25);
    B.attr("height", O);
  }
  Ab(
    void 0,
    l2,
    ((_d = b.mindmap) == null ? void 0 : _d.padding) ?? Cf.kanban.padding,
    ((_e = b.mindmap) == null ? void 0 : _e.useMaxWidth) ?? Cf.kanban.useMaxWidth
  );
}, "draw");
var Fe = {
  draw: Be
...
var je = g((e) => {
  ...
  for (let s = 0; s < e.THEME_COLOR_LIMIT; s++)
    e["lineColor" + s] = e["lineColor" + s] || e["cScaleInv" + s], Ln(e["lineColor" + s]) ? e["lineColor" + s] = H(e["lineColor" + s], 20) : e["lineColor" + s] = et(e["lineColor" + s], 20);
  const p = g((s, d) => e.darkMode ? et(s, d) : H(s, d), "adjuster");
  for (let s = 0; s < e.THEME_COLOR_LIMIT; s++) {
    const d = "" + (17 - 3 * s);
    u += `
...
//# sourceMappingURL=kanban-definition-ZSS6B67P-CmNuHNwG-5NOJCJCU.js.map
